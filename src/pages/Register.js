    ...
    <div className='w-96 p-7'>
        ...
        <form onSubmit={handleSubmit(handleRegister)}>
            ...
            <div className="form-control w-full max-w-xs">
                ...
                <input type='text' placeholder="Email" name="email"  className="input input-bordered w-full max-w-xs" onChange={e=>handleChange(e)}></input>
            </div>
            <div className="form-control w-full max-w-xs">
                <label className="label">
            ...
            <div className="form-control w-full max-w-xs">
                ...
                <input type='password' placeholder="Password" name="confirmPassword" className="input input-bordered w-full max-w-xs" onChange={e=>handleChange(e)}></input>
                <label className="label">
